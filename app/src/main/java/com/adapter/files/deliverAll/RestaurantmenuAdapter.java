...
//                listholder.restaurantRateTxt.setSelected(true);
            ...
            //String imgUrl = Utils.getResizeImgURL(mContext, mapData.get("vImage"), _hw, _hw, 0);//fixed width-height 60sdp image url
            ...
            if (mapData.get("vImage").isEmpty()){
                ...
                String imgUrl = Utils.getResizeImgURL(mContext, mapData.get("vImage"), wdt, 0, 0);

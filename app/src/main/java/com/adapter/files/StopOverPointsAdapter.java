  ...
  public boolean isTouch = false; // is in edit mode
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        ...
        if (!addTextChangeListner) {
            ...
            stopOverPointsSubRecyclerView.postDelayed(new Runnable() {
                @Override
                public void run() {
                    stopOverPointsSubRecyclerView.scrollToPosition(list.size());
                }
            },1000);
        }
...
//        });
        ...
        stopOverPointsSubRecyclerView.postDelayed(new Runnable() {
            @Override
            public void run() {
                stopOverPointsSubRecyclerView.smoothScrollToPosition(list.size());
            }
        },1000);

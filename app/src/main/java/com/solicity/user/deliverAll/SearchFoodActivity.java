...
public class SearchFoodActivity extends AppCompatActivity implements FoodSearchAdapter.OnItemClickList {
    ...
    public void onItemClick(int position) {
        ...
        foodSearchArrList.get(position).put("eAvailable", getIntent().getStringExtra("eAvailable"));
        foodSearchArrList.get(position).put("timeslotavailable", getIntent().getStringExtra("timeslotavailable"));

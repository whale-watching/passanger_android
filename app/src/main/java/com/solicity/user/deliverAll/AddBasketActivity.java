...
public class AddBasketActivity extends AppCompatActivity {
    ...
    ArrayList<String> optionIdListId = new ArrayList<>();
    StepView step_view;
    ...
    public void initView() {
        ...
        stepScrollview.setOnScrollChangeListener(new View.OnScrollChangeListener() {
            @Override
            public void onScrollChange(View v, int scrollX, int scrollY, int oldScrollX, int oldScrollY) {
                Logger.d("onScrollChange","::"+scrollX+"::"+scrollY);
            }
        });
      ...
      //  step_viewLayout.setListener(this);
        ...
        previousArea.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Logger.d("nextArea", "ppp::" + mViewPager.getCurrentItem());
        ...
        nextArea.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Logger.d("nextArea", "::" + mViewPager.getCurrentItem());
                mViewPager.setCurrentItem(mViewPager.getCurrentItem() + 1, true);
        ...
        step_view.setOnStepClickListener(new StepView.OnStepClickListener() {
            ...
            public void onStepClick(int step) {
                ...
                if (generalFunc.isRTLmode()) {
                    ...
                    Logger.d("TestSetpcount", "::" + step_view.getStepCount() + "::" + currentStep+"::"+step);
    ...
    private void updateBottomData() {
        ...
        totalPriceTxt.setText(new AppFunctions(getActContext()).formatNumAsPerCurrency(generalFunc, "" + generalFunc.convertNumberWithRTL(GeneralFunctions.convertDecimalPlaceDisplay(totalamout * getQty())), searchList.get("currencySymbol"), true));
        ...
        if (searchList.get("ispriceshow") != null && searchList.get("ispriceshow").equalsIgnoreCase("separate")) {
            ...
            totalPriceTxt.setText(new AppFunctions(getActContext()).formatNumAsPerCurrency(generalFunc, "" + generalFunc.convertNumberWithRTL(GeneralFunctions.convertDecimalPlaceDisplay(totalamout)), searchList.get("currencySymbol"), true));
        }
    }
    ...
    public void setData() {
        try {
            ...
            Picasso.get()
                    .load(Utils.getResizeImgURL(getActContext(), searchList.get("vImage"), 0, heightOfImage, width))/*.fit()*/
                    //  .load(Utils.getResizeImgURL(getActContext(), searchList.get("vImage"), ((int) Utils.getScreenPixelWidth(getActContext())), (int) getResources().getDimension(R.dimen._195sdp)))
...
//                                        totalPriceTxt.setText(searchList.get("currencySymbol") + " " + generalFunc.convertNumberWithRTL(GeneralFunctions.convertDecimalPlaceDisplay(Math.abs(toppingPrice) + totalamout - Math.abs(seloptionPrice))));
                                        totalPriceTxt.setText(new AppFunctions(getActContext()).formatNumAsPerCurrency(generalFunc, "" + generalFunc.convertNumberWithRTL(GeneralFunctions.convertDecimalPlaceDisplay(Math.abs(toppingPrice) + totalamout - Math.abs(seloptionPrice))), searchList.get("currencySymbol"), true));
                                        if (searchList.get("ispriceshow") != null && searchList.get("ispriceshow").equalsIgnoreCase("separate")) {
...
//                totalPriceTxt.setText(searchList.get("currencySymbol") + " " + generalFunc.convertNumberWithRTL(GeneralFunctions.convertDecimalPlaceDisplay(((GeneralFunctions.parseDoubleValue(0, searchList.get("fPrice")) * (getQty())) + Math.abs(toppingPrice) + Math.abs(seloptionPrice)))));
                totalPriceTxt.setText(new AppFunctions(getActContext()).formatNumAsPerCurrency(generalFunc, "" + generalFunc.convertNumberWithRTL(GeneralFunctions.convertDecimalPlaceDisplay(((GeneralFunctions.parseDoubleValue(0, searchList.get("fPrice")) * (getQty())) + Math.abs(toppingPrice) + Math.abs(seloptionPrice)))), searchList.get("currencySymbol"), true));
...
//                    totalPriceTxt.setText(searchList.get("currencySymbol") + " " + generalFunc.convertNumberWithRTL(GeneralFunctions.convertDecimalPlaceDisplay((Math.abs(toppingPrice) + Math.abs(seloptionPrice) * (getQty())) + Math.abs(toppingPrice))));
                    totalPriceTxt.setText(new AppFunctions(getActContext()).formatNumAsPerCurrency(generalFunc, "" + generalFunc.convertNumberWithRTL(GeneralFunctions.convertDecimalPlaceDisplay((Math.abs(toppingPrice) + Math.abs(seloptionPrice) * (getQty())) + Math.abs(toppingPrice))), searchList.get("currencySymbol"), true));
                }
            } else {
                ...
                if (generalFunc.getJsonValueStr("ENABLE_MULTI_OPTIONS_ADDONS", obj_userProfile).equalsIgnoreCase("YES")) {
                    ...
                    if (addItemCartBtn.getText().toString().equalsIgnoreCase(generalFunc.retrieveLangLBl("", "LBL_NEXT"))) {
                        ...
                        if (generalFunc.isRTLmode()) {
                            ...
                            Logger.d("TestSetpcount", "::" + btnstep + "::" + btnentStep);
                            btnstep--;
...
//            int newqty = GeneralFunctions.parseIntegerValue(0, QTYNumberTxtView.getText().toString().trim());
    ...
    public void mangeMinusView(AutoFitEditText rechargeBox) {
        if (Utils.checkText(rechargeBox) == true && getQty() > 0) {
...
//                totalPriceTxt.setText(searchList.get("currencySymbol") + " " + generalFunc.convertNumberWithRTL(GeneralFunctions.convertDecimalPlaceDisplay(QUANTITY * itemTotal)));
                totalPriceTxt.setText(new AppFunctions(getActContext()).formatNumAsPerCurrency(generalFunc, "" + generalFunc.convertNumberWithRTL(GeneralFunctions.convertDecimalPlaceDisplay(QUANTITY * itemTotal)), searchList.get("currencySymbol"), true));
                rechargeBox.setText(generalFunc.convertNumberWithRTL("" + QUANTITY));

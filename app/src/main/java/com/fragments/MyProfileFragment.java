...
import com.solicity.user.BusinessProfileActivity;
...
import com.solicity.user.EmergencyContactActivity;
import com.solicity.user.FavouriteDriverActivity;
import com.solicity.user.HelpActivity;
import com.solicity.user.InviteFriendsActivity;
import com.solicity.user.IssueReoprtActivity;
import com.solicity.user.MenuSettingActivity;
import com.solicity.user.MyProfileActivity;
import com.solicity.user.MyWalletActivity;
import com.solicity.user.NotificationActivity;
import com.solicity.user.R;
import com.solicity.user.SearchPickupLocationActivity;
import com.solicity.user.StaticPageActivity;
import com.solicity.user.VerifyInfoActivity;
import com.solicity.user.deliverAll.EditCartActivity;
import com.solicity.user.deliverAll.LoginActivity;
...
public class MyProfileFragment extends Fragment {
    ...
    ImageView backImg, editProfileImage, reportIssueImage;
    SelectableRoundedImageView userImgView, userImgView_toolbar;
    ImageView infoImg;
    MTextView userNameTxt, userNameTxt_toolbar, userEmailTxt, walletHTxt, walletVxt, generalSettingHTxt, accountHTxt, reportIssueHTxt;
    ...
    View notificationView, paymentView, privacyView, myBookingView, businessProView, mycartView, favDriverView, addMoneyView, aboutUsView, myWalletView,
            sendMoneyView, personalDetailsView, changePasswordView, changeCurrencyView, changeLangView, termsView, livechatView, verifyEmailView, verifyMobView, donationView,reportIssueView;
    ...
    ImageView notificationArrow, paymentArrow, privacyArrow, termsArrow, mywalletArrow, inviteArrow, helpArrow, aboutusArrow,
            mybookingArrow, businessProArrow, mycartArrow, favDriverArrow, addMoneyArrow, sendMoneyArrow, personalDetailsArrow, reportIssueArrow,
...
//        }
    ...
    public void manageView() {
        if (generalFunc.getJsonValue("ENABLE_REPORT_ISSUE", userProfileJson).equalsIgnoreCase("Yes")) {
            reportIssueArea.setVisibility(View.VISIBLE);
            reportIssueView.setVisibility(View.VISIBLE);
        } else {
            reportIssueArea.setVisibility(View.GONE);
            reportIssueView.setVisibility(View.GONE);
        }
...
//        if (generalFunc.getJsonValueStr(Utils.DONATION_ENABLE, obj_userProfile).equalsIgnoreCase("Yes")/* && !APP_TYPE.equals(Utils.CabGeneralTypeRide_Delivery_UberX)*/) {
    ...
    public void initViews() {
        ...
        reportIssueImage = view.findViewById(R.id.reportIssueImage);
        ...
        reportIssueHTxt = view.findViewById(R.id.reportIssueHTxt);
        ...
        reportIssueArea = view.findViewById(R.id.reportIssueArea);
        ...
        reportIssueView = view.findViewById(R.id.reportIssueView);
        ...
        reportIssueArrow = view.findViewById(R.id.reportIssueArrow);
        ...
        reportIssueArea.setOnClickListener(new setOnClickList());
        ...
        if (generalFunc.isRTLmode()) {
            ...
            reportIssueArrow.setRotation(180);
    ...
    public void setLabel() {
        ...
        reportIssueHTxt.setText(generalFunc.retrieveLangLBl("", "LBL_REPORT_ISSUES"));
    ...
    public class setOnClickList implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            switch (view.getId()) {
                ...
                case R.id.reportIssueArea:

                    new StartActProcess(getActContext()).startActWithData(IssueReoprtActivity.class, bn);
                    break;

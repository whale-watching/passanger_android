...
public class SetGeneralData {
    ...
    public SetGeneralData(GeneralFunctions generalFunc, JSONObject responseObj) {
        ...
        if (!generalFunc.getMemberId().equalsIgnoreCase("")) {
            ...
            storeData.put("STATELIST", generalFunc.getJsonValueStr("STATELIST", responseObj));
            storeData.put("CATEGORYLIST", generalFunc.getJsonValueStr("CATEGORYLIST", responseObj));
        } else {
